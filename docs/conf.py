# -*- coding: utf-8 -*-
#
# ufp documentation build configuration file, created by
# sphinx-quickstart on Tue Mar 17 15:39:24 2015.
#
...
latex_documents = [
  (master_doc, 'ufp.tex', u'ufp Documentation',
   u'별님', 'manual'),
]
...
man_pages = [
    (master_doc, 'ufp', u'ufp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ufp', u'ufp Documentation',
   author, 'ufp', 'One line description of project.',
   'Miscellaneous'),
]
